...
1. None Type: `None` is a `NoneType` object, and it is used to represent **the absence of a value**
...
##### Need to learn
'assert', 'class', 'global', 'lambda', 'nonlocal', 'yield'
...
- A function is a block of code that performs a specific task when the function is called (invoked). You can use functions to make your code reusabl, better organized, and more readable. Functions can have parameters and return values.
